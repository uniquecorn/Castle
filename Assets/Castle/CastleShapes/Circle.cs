...
namespace Castle.CastleShapes
{
    ...
    {
        public Circle(float radius, int roundedCornerRes=0, float roundedCornerRadius=0) 
            : base(128, radius, roundedCornerRes, roundedCornerRadius) { }

        public override int MaxResolution => 128;
